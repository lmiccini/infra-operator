...
from instanceha_ai.tools import ApprovalLevel, Tool, ToolRegistry, ToolResult, tool, registry
from instanceha_ai.safety import ApprovalManager, AuditLogger, RateLimiter, RateLimit, _sanitize_params
...
class TestReadTools(unittest.TestCase):
    def test_get_compute_services(self):
        from instanceha_ai.read_tools import get_compute_services
        mock_conn = Mock()
        mock_svc = Mock()
    ...
    def test_get_config(self):
        from instanceha_ai.read_tools import get_config
        mock_service = Mock()
    ...
    def test_get_kdump_hosts(self):
        from instanceha_ai.read_tools import get_kdump_hosts
        mock_service = Mock()
...
class TestDiagnosticTools(unittest.TestCase):
    def test_check_cluster_capacity(self):
        from instanceha_ai.diagnostic_tools import check_cluster_capacity
        mock_conn = Mock()
