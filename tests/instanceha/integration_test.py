...
class TestServiceInitialization(unittest.TestCase):
    ...
    def test_service_initialization_with_threads(self):
        ...
        with patch('threading.Thread') as mock_thread:
            ...
            service, metrics = instanceha._initialize_service()
            
            # Verify threads were created
            self.assertEqual(mock_thread.call_count, 1)  # Health check thread
...
class TestEvacuationWorkflow(unittest.TestCase):
    ...
    def test_evacuation_with_aggregate_filtering(self):
        ...
        self.mock_config.is_tagged_aggregates_enabled.return_value = True
